...
module.exports = {
    addFood: async (req, res) =>{
        ...
        if(!title || !foodTags || !category || !code || !restaurant || !description || !time || !price || !imageUrl || !additives) {
    ...
    getRandomFood: async (req, res) => {
        ...
        try {
            let randomFoodList = [];
            // check if code is provided in params
            if(req.params.code) {
            ...
            // if no code is provided in params or no Foods match the provided code
